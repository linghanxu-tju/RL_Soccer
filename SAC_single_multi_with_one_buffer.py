...
if __name__ == '__main__':
    ...
    parser.add_argument('--save_dir', type=str, default='OneBuffer/SAC/')
    ...
    save_dir = os.path.join(args.save_dir, str(args.p) + '_' + str(args.seed))
    ...
    tensorboard_dir_1 = os.path.join(test_save_dir, "test_4_" + str(args.p) + '_' + str(args.seed))
    tensorboard_dir_3 = os.path.join(test_save_dir, "test_5_" + str(args.p) + '_' + str(args.seed))
    tensorboard_dir_opp = os.path.join(test_save_dir, "test_opp_" + str(args.p) + '_' + str(args.seed))
    ...
    if not os.path.exists(tensorboard_dir_opp):
        os.makedirs(tensorboard_dir_opp)
    writer = SummaryWriter(log_dir=tensorboard_dir)
    writer_1 = SummaryWriter(log_dir=tensorboard_dir_1)
    writer_3 = SummaryWriter(log_dir=tensorboard_dir_3)
    writer_opp = SummaryWriter(log_dir=tensorboard_dir_opp)
